...
public class AssignmentController {
    ...
    @GetMapping("/{id}")
    ResponseEntity <Assignment> obtainAssignmentById(Long id) {
        return new ResponseEntity<>(assignmentService.obtainAssignmentById(id), HttpStatus.OK);
    }
    @PostMapping
    ResponseEntity <Assignment> saveAssignment(Assignment assignment) {
        assignmentService.saveAssignment(assignment);
        return new ResponseEntity<>(HttpStatus.CREATED);
    }
    @DeleteMapping("/{id}")
    ResponseEntity <Assignment> deleteAssignment(Long id) {
        assignmentService.deleteAssignment(id);
        return new ResponseEntity<>(HttpStatus.NO_CONTENT);
    }
    @PutMapping
    ResponseEntity <Assignment> updateAssignment(Assignment assignment) {
